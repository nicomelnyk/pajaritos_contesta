      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="bg-red-50 border border-red-300 rounded-lg p-4 mb-4">
            <p className="text-sm text-red-800 font-semibold mb-2">🚫 Group Posts Not Supported</p>
            <p className="text-sm text-red-700 mb-2">
              <strong>Facebook has blocked API access to group posts.</strong> Even with all permissions granted, 
              group posts cannot be accessed or commented on through the Graph API. This is a platform limitation, not a bug.
            </p>
            <p className="text-sm text-red-700">
              ✅ <strong>This app works for:</strong> Facebook Page posts and your own profile posts<br/>
              ❌ <strong>Does NOT work for:</strong> Group posts (any group, even if you're an admin)
            </p>
          </div>
          <p className="text-sm text-gray-600 mb-4">
            Paste a Facebook post URL from a <strong>Page</strong> or <strong>your profile</strong> (not groups) and write a comment to post it automatically.
          </p>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
            <p className="text-xs text-blue-800">
              <strong>Example working URLs:</strong><br/>
              • Page post: <code className="text-xs">facebook.com/{`{page-name}`}/posts/{`post-id`}</code><br/>
              • Your post: <code className="text-xs">facebook.com/{`{your-profile-id}`}/posts/{`post-id`}</code>
            </p>
          </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
            ...
            <li>Comment on Page posts or your own profile posts</li>
            <li className="text-red-600">⚠️ Group posts are blocked by Facebook's API (not supported)</li>
          </ul>
        </div>
      </main>
    </div>
